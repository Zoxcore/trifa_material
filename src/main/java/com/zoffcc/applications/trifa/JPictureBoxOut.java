...
public class JPictureBoxOut extends JComponent
{
    private static final String TAG = "trifa.JPictureBoxOut";

    public static JPictureBoxOut videooutbox = new JPictureBoxOut();
    ...
    public JPictureBoxOut()
    {
        JPictureBoxOut.this.setPreferredSize(dimension);
        JPictureBoxOut.this.setOpaque(false);
        JPictureBoxOut.this.setSizeMode(SizeMode.STRETCH);
