...
object InternationalizationUtils {
    ...
    private const val TAG = "trifa.i18nUtl"
    ...
    fun i18nP(key: String, amount: Int): String =
        try {
            ...
            Log.i(TAG, "Pattern does not match arguments for resource '$key' and locale '$locale")
            key
        }
    ...
    fun i18nF(key: String, vararg params: Any): String =
        try {
            ...
            Log.i(TAG, "Pattern does not match arguments for resource '$key'")
            key
        }
