...
dependencies {
    ...
    try
    {
        if ((os!!.isLinux) && (os_arch == "amd64") && (!running_on_nixos) && (!build_with_appimage))
        {
            ...
            implementation("com.github.zoff99:pkgs_zoffcc_sqlite-jdbc-sqlcipher:1.0.24")
    ...
    implementation("com.sksamuel.scrimage:scrimage-core:4.3.10")
    implementation("com.sksamuel.scrimage:scrimage-webp:4.3.10")
